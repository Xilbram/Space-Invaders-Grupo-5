...
class HUD(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.tempo_fase = 0
        self.fundo_tela = pygame.transform.scale(pygame.image.load(os.path.join('Imagens/space_background.jpg')), (self.__largura_janela, self.__altura_janela))
